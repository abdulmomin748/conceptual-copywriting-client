...
const AddService = () => {
    const handleAddService = event => {
        ...
        fetch(`https://personal-service-server.vercel.app/addService`, {
            method: 'POST',
            headers: {
                        ...
                        <div className="card flex-shrink-0 w-full max-w-[500px] shadow-2xl bg-base-100">
                            <form onSubmit={handleAddService} className="card-body text-xl">
                                <div className="form-control">
                                    ...
                                    <input type="text" name='sPhotUrl' placeholder="Photo Url" className="input text-white input-bordered" required/>
                                </div>
                                <div className="form-control">
                                    <label className="labelabel-text">
                                        <span className="label-text text-xl">Title</span>
                                    </label>
                                    <input type="text" name='sTitle' placeholder="Title" className="input text-white input-bordered" required/>
                                </div>
                                <div className="form-control">
                                    <label className="label">
                                        <span className="label-text text-xl">Description</span>
                                    </label>
                                    <input type="text" name='sDescription' placeholder="Description" className="input text-white input-bordered" required/>
                                </div>
                                <div className="form-control">
                                    <label className="label">
                                        <span className="label-text text-xl">Price</span>
                                    </label>
                                    <input type="text" name='sPrice' placeholder="Price" className="input text-white input-bordered" required/>
                                </div>
