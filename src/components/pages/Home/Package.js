                    ...
                    <div className="flex flex-wrap items-stretch -mx-4">
                        <div className="flex w-full mb-8 sm:px-4 md:w-1/2 lg:w-1/3 lg:mb-0">
                            <div className="flex flex-col p-6 space-y-6 rounded sm:p-8 shadow bg-gray-100">
                                <div className="space-y-2">
                                    ...
                                    <span className="text-6xl font-bold">$52
                                    </span>
                                    <span className='block mt-0 text-2xl text-gray-500'>starting at</span>
                                </div>
                        ...
                        <div className="w-full mb-8 sm:px-4 md:w-1/2 lg:w-1/3 lg:mb-0">
                            <div className="p-6 space-y-6 rounded shadow sm:p-8 bg-gray-100">
                                ...
                                <Link rel="noopener noreferrer" href="#" className="inline-block w-full px-5 py-3 font-semibold tracking-wider text-center rounded bg-gray-800 text-white">Get Started</Link>
                            </div>
                        </div>
                    </div>
                </div>
